...
- **AI 支援ワークフロー**: Gemini CLI・Claude Code でスライド構成を AI 補助で設計
...
VS Code で Markdown ファイルを開き、`Ctrl+Shift+P` → **「Marp: Open Preview to the Side」** でプレビューできます。
...
サンプルの SVG はそのまま使用することもできます（テキストを編集してください）。
